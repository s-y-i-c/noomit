    ...
    record ServiceRequestDetailResponse(
        ...
        static ServiceRequestDetailResponse from(ServiceRequestDetail detail) {
            return new ServiceRequestDetailResponse(
                    ...
                    detail.selectedSubCategoryId() == null ? null : Long.toString(detail.selectedSubCategoryId()),
                    detail.selectedCategoryId() == null ? null : Long.toString(detail.selectedCategoryId()),
                    detail.modelName(),
